package com.an80x86.receiptportal;

import com.an80x86.receiptportal.controller.WelcomeController;
...
public class WelcomeControllerTest {
    ...
    public void main() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute("message", equalTo("Receipt Portal")))
                .andExpect(model().attribute("tasks", is(expectedList)))
                .andExpect(content().string(containsString("Hello, Receipt Portal")));
